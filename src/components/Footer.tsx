    ...
    return (
        <footer className="footer pt-3 pb-5">
            <div className="container">
                <div className="row">
                    <div className="col-9">
                        <Translate id="footer.main.title" values={{endTime: new Date().getFullYear()}}></Translate><br/>
                        <span className="site-footer-content"><Translate id="footer.main.description"></Translate></span>
                    </div>
                        ...
                        <svg height="50" xmlns="http://www.w3.org/2000/svg" width="50">
                            <g transform="scale(.4) translate(50, 12)">
                                <path stroke="#000"
                                      ...
                                      fill-opacity="null" stroke-opacity="null" stroke-width="0" fill="#fff"></path>
                                <path
